...
import com.example.snapget.core.model.Friendship
import com.example.snapget.core.model.FriendshipStatus
import com.example.snapget.core.model.Message
import com.example.snapget.core.model.Notification
import com.example.snapget.core.model.NotificationType
...
/**
 * Sample data for the Snapget app
...
object SampleData {
    ...
    // Settings hien thi trong app — dung chung nguon TINH voi runtime
    // (SettingDefaults) de preview khop that, khong lap danh sach.
    val settingList: List<Setting> = SettingDefaults.defaults
    ...
    val notifications = listOf(
        ...
        Notification(
            ...
            title = "System Update",
            description = "Snapget has been updated to version 1.0.1",
